...
const Portfolio = () => {
  ...
  const projects = [
    {
      title: 'Detection System for Driver safety using DeepLearning',
      description: 'A driver safety detection system uses deep learning to monitor driver behavior and environmental conditions to prevent accidents and ensure road safety..',
      tech: ['convolution Neural Networks(CNNs)', 'OpenCV', 'TensorFlow'],
      highlights: [
        'Drowsiness detection is a safety technology it uses the Opencv, Tensorflow libraries this can prevent accidents that are caused by drivers who fell asleep while driving. ',
        'Developed a driver safety system that reduced accident rates by 85% by detecting drowsiness and issuing alerts.'
      ],
      icon: Smartphone
    },
    {
      title: 'Crop Recommendation System using Machine Learning',
      description: 'A crop recommendation system uses machine learning to suggest the most suitable crop to grow based on soil, weather, and environmental conditions.',
      tech: ['Scikit-learn', 'Pandas', 'NumPy', 'Flask'],
      highlights: [
        'Built a crop recommendation system that increased agricultural yield by 92% using adaptive algorithms that consider soil, weather, and environmental conditions. ',
        'Implemented adaptive algorithms to suggest crops based on soil, weather, and environmental conditions. '
      ],
      icon: Zap
    },
  ];
  ...
  const skills = {
    ...
    'Technologies/Frameworks': ['HTML', 'CSS', 'React Native', 'MongoDB', 'MySQL']
  };
      ...
      <section id="home" className="min-h-screen flex items-center justify-center relative pt-20">
        <div className="text-center z-10 max-w-4xl mx-auto px-3 mt-3">
          ...
          <div className="text-xl md:text-2xl text-gray-300 mb-8 animate-fade-in-up delay-500">
            AI/ML Enthusiast , Full-Stack Developer and React Native
          </div>
          ...
          <div className="flex justify-center gap-6 animate-fade-in-up delay-1200">
            ...
            <a 
              href="https://github.com/kurmasanju"
            ...
            <div className="space-y-6">
              <BackgroundGradient>
                ...
                <p className="text-gray-300 leading-relaxed mb-4">
                  ...
                  currently pursuing my Bachelor's degree at Malla Reddy University with a CGPA of 8.12.
                </p>
              ...
              <BackgroundGradient>
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2 mt-2">
                    ...
                    <span className="text-purple-300 font-semibold">CGPA: 8.12</span>
                  </div>
                </div>
              </BackgroundGradient>
            </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <BackgroundGradient className="max-w-4xl mx-auto">
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between mb-6">
              <div>
                <h3 className="text-3xl font-bold text-white mb-2">AI & Azure virtual internship</h3>
                <p className="text-purple-400 text-xl font-semibold">Edunet foundation</p>
                <p className="text-gray-400">collaboration with Microsoft and AICTE</p>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="space-y-4">
                {[
                  'Developed criminal face Detection Recognition using Machine Learning',
                  'proposed solutions are LBPH, real time recognization',
                  'Algorithm are Data input,Training process,prediction process'
                ].map((item, index) => (
              ...
              <div className="space-y-4">
                {[
                  'During this internship learned about Building AI and ML models on Azure',
                  'Exploring cloud-based solutions for AI development',
                ].map((item, index) => (
                  <div key={index} className="flex items-start gap-3">
                    <div className="w-2 h-2 bg-purple-400 rounded-full mt-2 flex-shrink-0"></div>
                    <p className="text-gray-300">{item}</p>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <BackgroundGradient>
              ...
              <h4 className="font-semibold text-purple-400 mb-2 text-lg">
                Paticipated  National Level Innovation & Entrepreneurship Summit at Malla Reddy University
              </h4>
              <h4 className="font-semibold text-purple-400 mb-2 text-lg">
                Led the hockey team as Vice-Captain, promoting excellence both on and off the field.
              </h4>
            </BackgroundGradient>
            ...
            <BackgroundGradient>
              ...
              <div className="space-y-4">
                <div className="border-l-2 border-purple-400 pl-4">
                  <h4 className="font-semibold text-white">NPTEL Introduction To Internet Of Things Certification</h4>
                  <p className="text-purple-400 text-sm">• Nov 2024</p>
        ...
        <div className="max-w-4xl mx-auto text-center">
            ...
            {[
              {
                icon: Mail,
                title: 'Email',
                subtitle: 'sanjaykurma06@gmail.com',
                href: 'mailto:sanjaykurma06@gmail.com',
              ...
              },
              {
                ...
                href: 'https://www.linkedin.com/in/sanjay-kurma-59849330b',
          ...
          <BackgroundGradient className="max-w-2xl mx-auto">
            <div className="text-center">
              ...
              <button 
                onClick={() => window.open('mailto:sanjaykurma06@gmail.com', '_blank')}
      ...
      <footer className="py-8 px-4 border-t border-gray-800">
        <div className="max-w-6xl mx-auto text-center">
          <p className="text-gray-400">
            © 2025 sanjay kurma. Crafted with passion using Next.js and modern web technologies.
          </p>
          <div className="flex justify-center gap-6 mt-4">
            <a href="https://github.com/kurmasanju" className="text-gray-400 hover:text-purple-400 transition-colors duration-300">
              <Github size={20} />
            </a>
            <a href="https://www.linkedin.com/in/sanjay-kurma-59849330b" className="text-gray-400 hover:text-purple-400 transition-colors duration-300">
              <Linkedin size={20} />
            </a>
            <a href="mailto:sanjaykurma06@gmail.com" className="text-gray-400 hover:text-purple-400 transition-colors duration-300">
              <Mail size={20} />
            </a>
          </div>
        </div>
